...
public class SimpleTagger
{
  ...
  //  MalletLogger.getLogger(SimpleTagger.class.getName());
	private static Logger logger = MalletLogger.getAnonymousLogger();
...
public static class SimpleTaggerSentence2FeatureVectorSequence extends Pipe
  ...
  private static final CommandOption.File outOption = new CommandOption.File
  (SimpleTagger.class, "out-file", "FILENAME", true, null,
   "The filename for reading (train/run) or saving (train) the model.", null);
  ...
  public static void main (String[] args) throws Exception
  {
    ...
    if (outOption.value != null)
    {
    	fstream = new FileWriter(outOption.value);
		outW = new BufferedWriter(fstream);
    }
